<div role="tabpanel">
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#symbols" aria-controls="symbols" role="tab" data-toggle="tab">Symbols</a></li>    
  </ul>
  <!-- Tab panes -->
  <div class="tab-content" id="emoji_list_modal">
    <div role="tabpanel" class="tab-pane active" id="people">
	  ...
	  $arr = explode("\n",$str);
	  foreach($arr as $val){
		  echo '<img src="assets/emojis/'.trim($val).'.png" data-src="'.trim($val).'" class="emoji">';
	  }
	  ?>    
    </div>
